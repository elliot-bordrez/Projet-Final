...
<head>
    ...
    <link rel='stylesheet' type='text/css' media='screen' href='../../5etoile/main.css'>
...
if(isset($_SESSION['Connexion'])){
        ...
        if($TheUser->isAdmin()){
            ...
            if(isset($_POST["etoile"])){
                ...
                $Note = new Note($_SESSION['id'],$_POST["idStadeNote"],$_POST["etoile"]);
                $Note->saveInBdd();
            }
        ...
        <form action="" method="Post" onchange="this.submit()">
            <select id="idstade" name="idstade">
                <option value="null" >Choisi un stade</option>
            <?php
                $afficheEtoile = false;
            ...
            <?php if($afficheEtoile){
                ...
                <form action="" method="Post"  class="stars5" onclick="this.submit();">
                    ...
                    <input type="hidden"  name="idStadeNote" value="<?= $Stade->getId()?>" >
